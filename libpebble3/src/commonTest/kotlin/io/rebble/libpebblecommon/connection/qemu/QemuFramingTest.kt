...
class QemuFramingTest {
    @Test
    fun frameHasTheWireLayoutTheFirmwareExpects() {
        assertContentEquals(
    ...
    @Test
    fun reassemblesAFrameSplitAcrossEveryPossibleReadBoundary() {
    ...
    @Test
    fun readsSeveralFramesFromOneChunk() {
    ...
    @Test
    fun keepsAHeaderSignatureThatStraddlesTwoReads() {
